        	...
        	<div class="container">
            	<!-- Brand and toggle get grouped for better mobile display -->
            		<div class="navbar-header">
                		...
                		<a class="navbar-brand" href="inicio.jsp"><span class="glyphicon glyphicon-home"></span> PyLearning</a>
            		</div>
...
Sed eget lacinia orci, ultricies tempor est.</p>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-6 ">
                <div class="thumbnail">
                <img src="images/pythonInc.png" alt="">
                    <div>
                        <h3>Tipos primitivos e variáveis</h3>
                        <p>Lição sobre os conceitos basicos de tipos primitivos e variáveis</p>
                        <a  style="margin-top: 30px;" href="licao.jsp" class="btn btn-primary text-center btn-block">Continuar</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="thumbnail">
                    ...
                    <div>
                        ...
                        <a href="licao.jsp" style="margin-top: 5px;" class="btn btn-primary text-center btn-block">Continuar</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <a href="licao.jsp" style="margin-top: 75px;" class="btn btn-primary text-center btn-block">Continuar</a>
                </div>
            </div>
